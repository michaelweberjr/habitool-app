...
habitRouter.post("/addHabit", habitController.addHabit, sessionController.updateSession, (req, res) => {
  return res.status(200).json({ updatedDoc: res.locals.updatedDoc });
});

habitRouter.post("/removeHabit", habitController.removeHabit,  sessionController.updateSession, (req, res) => {
  return res.status(200).json({ updatedDoc: res.locals.updatedDoc });
});
